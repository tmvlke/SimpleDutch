...
class MainContract {
    ...
    sealed class Event : BaseViewEvent {
        data class MainTabSelection(val type: MainTabEnum) : Event()
    }
    ...
    data class State(
        ...
        val openTab: MutableState<MainTabEnum>,
    ) : BaseViewState
    ...
    sealed class Effect : BaseViewSideEffect {
        data class MoveMainTab(val mainTabEnum: MainTabEnum) : Effect()
        sealed class Navigation : Effect() {
            object GoToSplash : Navigation()
        }
    }
}
